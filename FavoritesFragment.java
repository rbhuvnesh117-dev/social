...
public class FavoritesFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Match behaviour from Feed/Stream so auto-play works consistently:
        mRecyclerView.setItemViewCacheSize(100);
        mRecyclerView.setDrawingCacheEnabled(true);
        mRecyclerView.setDrawingCacheQuality(View.DRAWING_CACHE_QUALITY_HIGH);

        mRecyclerView.setAdapter(itemsAdapter);
        // IMPORTANT: attach adapter so AdvancedItemListAdapter can register autoplay listeners
